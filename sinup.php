    ...
    <div class="container">
      <div class="logo">
        ...
        <div class="list">
          ...
          <a href="html/sigin.php">تسجيل الدخول</a>
      ...
      <p class="p2"> يرجى تحديد المواد التي ترغب في دراستها</p><br>
        ...
        <div>
                    ...
                    <select class="model" name="teacher" placeholder="enter text" id="">
                        ...
                        <option value="teacher1">حفظ القرأن الكريم</option>
                        <option value="teacher2">تفسير القرأن </option>
                        <option value="teacher3">احكام التجويد</option>
                        <option value="teacher4">الفقه</option>
                      </select>
          </div>
